...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public static final String DEFAULT_TARGET_LANGUAGE_CODE = "ko";
  ...
  */
  ...
  public void onCreate(Bundle icicle) {
    ...
    //HJS OCR 결과를 OCR_Result_Check.xml로 전달
    /*
    CaptureActivity.java == capture.xml
    OcrResultCheck.java == OcrResult_check.xml
    */
    ...
    confirmbutton.setOnClickListener(new Button.OnClickListener() {
      public void onClick(View v) {
        //Sub로 가는 Intent생성
        Intent intent = new Intent(CaptureActivity.this, OcrResultCheck.class);
        //Ocr 인식 결과 받아오기
        String ocr_result = lastResult.getText();

        //ocr_result를 Intent로 전송
        intent.putExtra("OCR_RESULT_TEXT", ocr_result);
...
//    adapter = new MyAdapter();
  ...
  //http://blog.naver.com/PostView.nhn?blogId=rkdwnsdud555&logNo=220298826210
...
//            view.setText(ocr_list[position]);
...
//  }
  ...
  private void initCamera(SurfaceHolder surfaceHolder) {
    ...
    try {
      ...
      showErrorMessage("Error", "Could not initialize camera. Please try restarting device. IOEXCEPTION");
    } catch (RuntimeException e) {
      // Barcode Scanner has seen crashes in the wild of this variety:
      // java.?lang.?RuntimeException: Fail to connect to camera service
      showErrorMessage("Error", "Could not initialize camera. Please try restarting device. LONG RUNTIME");
    }   
  }
...
*/
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    //HJS laguage:Korean지우기
    //TextView sourceLanguageTextView = (TextView) findViewById(R.id.source_language_text_view);
    //sourceLanguageTextView.setText(sourceLanguageReadable);
    TextView ocrResultTextView = (TextView) findViewById(R.id.ocr_result_text_view);
    ocrResultTextView.setText(ocrResult.getText());//HJS OcrResultText.java 에 있는 getText()가 결과 문장을 불러오는거 같음
